...
public class Player implements Serializable
{
    ...
    public void socketSetup() throws UnknownHostException, IOException{
        ...
        synchronized(requestOut){
            requestOut.writeBoolean(true); //Der Server muss ja wissen, was der Client eigentlich will. True steht fÃ¼r requestClient, false fÃ¼r TaskClient.
    ...
    */
    ...
    public void keyEvent(KeyEvent e, char type) {
        if (!isActive())return;  // wenn ein MenÃ¼ offen ist, dann passiert nichts
    ...
    public void windowEvent(WindowEvent e, char type){
        if (type=='c'){ //SchlieÃŸen des Fensters
            logout();
        }
    }
