...
public class ShipC extends Sandbox implements Serializable
{
    ...
    public static ArrayList<ShipC> shipCs=new ArrayList<ShipC>(); //Tabelle, die alle Schiffe enthält, muss eigens (de-)serialisiert werden!
    ...
    public ShipC(Block[][] map, ArrayList<SandboxInSandbox> subsandboxes, ShipS shipS, Timer spaceTimer){
