 ...
 *   Für eine vermutlich nicht vollständige Liste aller Requests siehe client.Request
 */
public class ServerCreator{
                                        ...
                                        try{
                                            ...
                                            if ((id==-1 && (req.todo.equals("Main.newPlayer") || req.todo.equals("Main.getPlayer")))
                                                ...
                                                timeOfLastAction=System.currentTimeMillis();
                                                  ...
                                                  //Ausnahmen sind login und mit id -1 Main.newPlayer und Main.getPlayer-Requests (die finden bereits im Login-Menü statt)
    ...
    public static class StoppableThread extends Thread{
         ...
         * Nicht immer ein sinnvoller Wert, nur, damit die Main-Klasse in logout() den Thread schließen kann
         */
        int id=-1;
